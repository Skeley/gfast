...
type (
	ISysUser interface {
		...
		GetUserByMobile(ctx context.Context, mobile string) (user *model.LoginUserRes, err error)
		GetUserByUnionId(ctx context.Context, unionId string) (user *model.LoginUserRes, err error)
