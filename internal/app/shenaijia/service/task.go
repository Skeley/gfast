...
type (
	ITask interface {
		...
		ListStage(ctx context.Context, req *v1.TaskListStageReq) (res *v1.TaskListStageRes, err error)
		AddStage(ctx context.Context, req *v1.TaskAddStageReq) (res *v1.TaskAddStageRes, err error)
		UpdateStage(ctx context.Context, req *v1.TaskUpdateStageReq) (res *v1.TaskUpdateStageRes, err error)
		DeleteStage(ctx context.Context, req *v1.TaskDeleteStageReq) (res *v1.TaskDeleteStageRes, err error)
		ListStep(ctx context.Context, req *v1.TaskListStepReq) (res *v1.TaskListStepRes, err error)
